...
def location_view(request):
    ...
    return render_to_response('pages/location.html', {'request': request, 'venue_images': all_images_full, 'messages': storage})
...
def homepage_view(request):
    ...
    return render_to_response('pages/home.html', {'request': request, 'quotes': quotes, 'messages': storage})
